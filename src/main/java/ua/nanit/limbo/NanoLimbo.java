...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "18ac8770-5301-4b6a-8fd9-b933472d951f"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "freemc-ljfpro.ljfwmg.pp.ua");        // argo固定隧道隧道域名
        ...
        envVars.put("S5_PORT", "50125");            // socks5节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("REALITY_PORT", "50125");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
        ...
        envVars.put("NAME", "freemc-ljfpro");               // 节点备注名称
